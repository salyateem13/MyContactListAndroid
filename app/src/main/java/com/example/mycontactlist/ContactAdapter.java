...
public class ContactAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            TextView contactAddress = (TextView) v.findViewById(R.id.textStreet);
            TextView contactCityStateZip = (TextView) v.findViewById(R.id.textCity);
            ...
            if(position %2 == 1) {
               // v.setBackgroundColor(ContextCompat.getColor(adapterContext,R.color.backgroundOWhite ));

                contactName.setTextColor(ContextCompat.getColor(adapterContext,R.color.backgroundRed));
            }
            else
            {
                //v.setBackgroundColor(ContextCompat.getColor(adapterContext,R.color.backgroundRed ));
               // contactNumber.setTextColor(ContextCompat.getColor(adapterContext,R.color.backgroundRed ));
            }
        }
        catch (Exception e) {
            e.printStackTrace();
